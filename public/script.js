...
// "Extensive experience of 10 years in leading the effort to architect, design and build DevOps solutions acting as the primary point of contact and 20 years of Linux systems administration .  Skilled in building, developing, and managing a high-performing infrastructure and DevOps team to meet the needs of a rapidly growing and changing business in an even more rapidly changing technology landscape . Adept in designing and implementing build, deployment, and configuration management; implementing test designs; building and testing automation tools for infrastructure provisioning . Instrumental in leading and executing an effort to integration DevOps on the services that are using cloud platforms; implementing continuous improvement ideas/projects, optimizing the DevOps function Up-to-date on latest industry trends; able to articulate trends and potential clearly and confidently ; good interpersonal skills and communication with all levels of management)";
...
//   checkEmail(email);
//   checkRequiredFields([username, email, message]);
